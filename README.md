...
The goal of regexcite524mg is to make regular expressions more exciting!
It provides convenience functions to make some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the development version of regexcite524mg from
[GitHub](https://github.com/) with:

``` r
# install.packages("pak")
pak::pak("michael-gelfand/regexcite524mg")
```
...
That’s exactly what `regexcite524mg::str_split_one()` does.

``` r
library(regexcite524mg)
